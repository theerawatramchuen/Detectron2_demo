...
config_file_path = "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml"
...
train_json_anno_path = "train.json"

test_dataset_name = "LP_test"
test_images_path = "test"
test_json_anot_path = "test.json"

cfg_save_path = "IS_cfg.pickle"

#########################
register_coco_instances(name = train_dataset_name, metadata={},
json_file=train_json_anno_path, image_root=train_images_path)

register_coco_instances(name = test_dataset_name, metadata={},
json_file=test_json_anot_path, image_root=test_images_path)
